          ...
          <div class="slider">
            <div class="slides">
              <div class="button-container">
                ...
                <GoogleLogin
                  class="google-login-button custom-button"
                  :params="params"
                ...
                <button
                  ...
                  OnFacebookAuthSuccess="OnFacebookAuthSuccess"
                  version="3.1"
                  OnFacebookAuthFail="OnFacebookAuthFail"
                >
              ...
              <form class="username-form">
                ...
                <button
                  ...
                  v-if="isCurrentNewUser && isEmailMode"
                >
...
export default {
  ...
  mounted() {
    axios.get('/api/users/fetch-all-users').then((resp) => console.log(resp));
  },
  data() {
    return {
  ...
  methods: {
    ...
    slideToLoginSection(topText, bottomText) {
      ...
      document.querySelector('.promo-text').children[2].innerHTML = topText;
      document.querySelector('.promo-text').children[3].innerHTML = `${bottomText}!`;
    },
